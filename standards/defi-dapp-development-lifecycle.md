...
source: "https://app.notion.com/p/DeFi-dApp-Development-Project-Lifecycle-2b735822a597809aaf67f9c60119efc9"
...
>
> **Source:** [Notion draft](https://app.notion.com/p/DeFi-dApp-Development-Project-Lifecycle-2b735822a597809aaf67f9c60119efc9)

**Doc Type:** Standard
**Date:** 2025-11-26
**Department:** Security / Engineering / Product
**Purpose:**
To define the secure lifecycle for DeFi dApp development, covering requirements → deployment → monitoring, with RACI assignments and security gates to prevent catastrophic fund loss, as repeatedly documented in major Web3 incidents .
**Scope:**
...
### Key Risks Identified from Historical Exploits:
...
- Key compromises (Wintermute vanity RNG flaw )
- Hot wallet use in deployments (Ronin, Bybit, DMM Bitcoin )
---
...
- CIS Controls v8
### **Exploit-Based Justification (from your document)**
...
- Wintermute: vanity address RNG flaw → hardware wallet enforcement
